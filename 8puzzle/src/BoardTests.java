...
public class BoardTests {
  ...
  private Board createRandomizedBoard(int size) {
    int[][] array = new int[size][size];
    for (int i = 0; i < size; i++) {
      for (int j = 0; j < size; j++) {
        array[i][j] = i * size + j;
  ...
  public void testHamming() {
    ...
    assertEquals(5, createAnyBoard(3, new int[] { 8, 1, 3, 4, 0, 2, 7, 6, 5 })
        .hamming());
  }
  ...
  public void testManhattan() {
    ...
    assertEquals(2, createAnyBoard(3, new int[] { 2, 1, 3, 4, 5, 6, 7, 8, 0 })
        .manhattan());
    assertEquals(6, createAnyBoard(3, new int[] { 8, 2, 3, 4, 5, 6, 7, 1, 0 })
        .manhattan());
    assertEquals(10, createAnyBoard(3, new int[] { 8, 1, 3, 4, 0, 2, 7, 6, 5 })
        .manhattan());
  }

  @Test
  public void testTwin() {
    assertEquals(createAnyBoard(3, new int[] { 2, 1, 3, 4, 5, 6, 7, 8, 0 }),
        createAnyBoard(3, new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 0 }).twin());
    assertEquals(createAnyBoard(3, new int[] { 0, 2, 3, 4, 5, 6, 7, 8, 1 }),
        createAnyBoard(3, new int[] { 0, 3, 2, 4, 5, 6, 7, 8, 1 }).twin());
    assertEquals(createAnyBoard(3, new int[] { 5, 0, 4, 2, 3, 8, 7, 1, 6 }),
        createAnyBoard(3, new int[] { 5, 0, 4, 3, 2, 8, 7, 1, 6 }).twin());
  ...
  @Test
  public void ttt() {
    Board board=createRandomizedBoard(3);
  }
}